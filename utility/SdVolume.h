 ...
 */
/*
 * Modified by Ben Peters (ben@ardusat.com) to add a character type to the 
 * cache_t union for use in the Ardusat SDK
 */
#ifndef SdVolume_h
#define SdVolume_h
/**
...
union cache_t {
  ...
  // Used as an output buffer for ArdusatSDK 
  char output_buf[512];     
};
//------------------------------------------------------------------------------
/**
